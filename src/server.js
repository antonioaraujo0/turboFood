...
const swaggerOptions = {
  definition: {
    ...
    info: {
      ...
      contact: { name: 'JARR - Logistics & Innovation', url: 'https://github.com/ravarmes' },
    },
...
app.get('/', (req, res) => {
  res.json({
    ...
    endpoints: {
      cadastros: { categorias: '/categorias', produtos: '/produtos', clientes: '/clientes', entregadores: '/entregadores', veiculos: '/veiculos', enderecos: '/enderecos' },
      processosDeNegocio: { pedidos: '/pedidos', pagamentos: '/pagamentos', entrega: '/entrega' },
    },
  });
});
